...
variables = ["Total cost", "Total Generation", "Redispach", 
...
cost = vcat(df_pi_in.cost, df_ldr_in.cost, df_pwl_in.cost, df_pi_out.cost, df_ldr_out.cost, df_pwl_out.cost)
...
values = Matrix(hcat(cost,g , Δ, r_up, r_dn, γ, γ_RT, δ, δ_RT, creation_time, optimization_time)')
